#integration of all 3 component
                    ...
                    if not user_query:
                        ...
                        try:
                            with st.spinner("🔄 Processing document and gathering insights..."):
                                ...
                                -Legal Domain : Mention the specific type to which the case belongs
                                -Your Response: Here respond to the user's question
                ...
                if result:
                    ...
                    with col2:
                        if st.button("📞 Contact Lawyer", key="contact_lawyer", use_container_width=True):
                            redirect_url = f"https://lawyer-hub-tau.vercel.app/lawyer/{result['id']}"
